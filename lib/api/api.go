...
func (s *service) Serve(ctx context.Context) error {
	...
	if multiUserAuth {
		...
		s.registerTrashEndpoints(restMux)
		if s.notifManager != nil {
			s.registerNotificationEndpoints(restMux)
		}
		...
		if s.provisioningStore != nil {
			s.registerAdminPlatformEndpoints(restMux)
		}
		if s.storagePoolStore != nil {
			s.registerStoragePoolEndpoints(restMux)
		}
		if s.backupStore != nil {
			s.registerBackupEndpoints(restMux)
		}
